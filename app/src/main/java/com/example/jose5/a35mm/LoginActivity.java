...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(mEmail.contains("@")){
                //user
                JSONArray user= c.Query("SELECT * FROM Users WHERE email="+"'"+mEmail+"'" +" and pass="+"'"+mPassword+"'");
                if(user!=null){
                    try {
                        mEmail=user.getJSONObject(0).getString("idUser");
                ...
                //admin
                JSONArray admin = c.Query("SELECT * FROM Admin WHERE idAdmin="+"'"+mEmail+"'" +" and pass="+"'"+mPassword+"'");
                isAdmin=true;
                if(admin!=null){
